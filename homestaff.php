    ...
    <div id="main" style="background-color: #042A38;height: auto;color:#fff !important">
        ...
        <section style="color:#fff !important">
            ...
            if($res)
            {
                ...
                echo "<table id=\"le\"><thead><tr><td>Quiz id</td>&nbsp;<td>Serial no.</td><td>score obtained</td><td>Max Score</td></tr></thead>";
                while ($row = mysqli_fetch_assoc($res)) {                
                    echo "<tr><td>".$row["quizid"]."</td><td>".$row["slno"]."</td><td>".$row["score"]."</td><td>".$row["totalscore"]."</td></tr>"; 
                }
                echo "</table><br><br>";
            }
            else{
