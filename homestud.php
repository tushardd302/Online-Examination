    ...
    <div style="background-color: #042A38;height: auto;">
        ...
        <?php 
            ...
            if($res)
            {
                ...
                echo "<table id=\"le\"><thead><tr><td>Serial no.</td><td>Quiz Id</td><td>Score</td><td>Total Score</td><td>Remark</td><td>Student Mail ID</td></tr></thead>";
                while ($row = mysqli_fetch_assoc($res)) {                
                    echo "<tr><td>".$row["slno"]."</td><td>".$row["quizid"]."</td><td>".$row["score"]."</td><td>".$row["totalscore"]."</td><td>".$row["remark"]."</td><td>".$row["mail"]."</td></tr>"; 
                }
                echo "</table><br><br><br>";
            }
            else{
